...
<head>
    ...
    <title>Exercise 1: Getting Started with PHP - Dalsi</title>
</head>
<body>
...
<h3>3.3 Define three variables: $g1 = 5, $g2 = 4, and $g3 = 5. 
    ...
    The table should be structured with columns for Serial Number (S.n.), Name, and Grade, and 
    it should look like this:</h3>
